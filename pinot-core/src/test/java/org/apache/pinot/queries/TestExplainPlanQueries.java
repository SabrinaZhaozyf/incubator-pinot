...
public class TestExplainPlanQueries {
  ...
  public void testExplainPlanQueries() {
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT * FROM testTable "
        + "WHERE (invertedIndexCol1 = 1.5 AND sortedIndexCol = 1) OR "
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT * FROM testTable "
        + "WHERE invertedIndexCol1 > 10 AND invertedIndexCol2 >= 20 "
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT * FROM testTable "
        + "WHERE sortedIndexCol > 10 OR sortedIndexCol >= 20 "
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT * FROM testTable "
        + "WHERE rangeIndexCol1 > 10 AND rangeIndexCol2 >= 20 "
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT noIndexCol1, invertedIndexCol1, noIndexCol2, sortedIndexCol, rangeIndexCol1 FROM testTable "
        + "WHERE noIndexCol1 > 10 AND noIndexCol2 >= 20 "
        + "AND noIndexCol3 < 30 AND noIndexCol4 <= 40 AND noIndexCol5 BETWEEN 50 AND 60 "
        + "AND noIndexCol6 = 70 AND noIndexCol7 != 80 AND noIndexCol8 IN (100, 110) AND noIndexCol9 NOT IN ('foo', 'bar')" + LIMIT;
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:noIndexCol1, invertedIndexCol1, noIndexCol2, sortedIndexCol, rangeIndexCol1)", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:100)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    addRowToResultTable(resultRows, "PROJECT(noIndexCol1, invertedIndexCol1, noIndexCol2, sortedIndexCol, rangeIndexCol1)", 3, 2);
    addRowToResultTable(resultRows, "FILTER(operator:AND)", 4, 3);
    ...
    explainPlanQuery = "EXPLAIN PLAN FOR SELECT DATETIMECONVERT(col1), col2 FROM testTable "
        + "WHERE DIV(bar, foo) BETWEEN 10 AND 20 "
        + "AND arrayLength(col) > 2 "
        + "AND invertedIndexCol1 * 5 < 1000 " + LIMIT;
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:datetimeconvert(col1), col2)", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:100)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    explainPlanQuery = "SELECT count(*), max(col1), sum(col2), avg(col3) FROM testTable WHERE invertedIndexCol1 = 1";
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:count(*), max(col1), sum(col2), avg(col3))", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:1)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    explainPlanQuery = "SELECT count(*), max(col1), sum(col2), avg(col3) FROM testTable WHERE invertedIndexCol1 = 1 AND col1 = 20";
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:count(*), max(col1), sum(col2), avg(col3))", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:1)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    explainPlanQuery = "SELECT col2, max(col1), min(col4) FROM testTable WHERE invertedIndexCol2 = 10 GROUP BY col2";
    resultRows = new ArrayList<>();
    ...
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:col1, col2, max(col3), min(col4))", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(sort:[col1 ASC, max(col3) DESC],limit:1)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    addRowToResultTable(resultRows, "AGGREGATE_GROUPBY(groupKeys:col1, col2,aggregations:max(col3), min(col4))", 3, 2);
    addRowToResultTable(resultRows, "PROJECT(col4, col2, col1, col3)", 4, 3);
    addRowToResultTable(resultRows, "FILTER(operator:TEXT_MATCH,predicate:text_match(textIndexCol,'foo'))", 5, 4);
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(sort:[max(col1) DESC],limit:1)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:max(col1), min(col4), datetimeconvert(col2))", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(havingFilter:max(col1) > 20,sort:[max(col1) DESC],limit:1)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    // Test 21: distinct
    explainPlanQuery = "SELECT DISTINCT col1, col2 FROM testTable WHERE invertedIndexCol2 = 10";
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:col1, col2)", 0, -1);
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:10)", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(havingFilter:sum(col3) > 100,sort:[col1 DESC],limit:1)", 2, 1);
    ...
    explainPlanQuery = "SELECT col1 as groupByCol1, col2 as groupByCol2, max(col3) as maxCol3, min(col4) FROM testTable "
        + "WHERE TEXT_MATCH(textIndexCol, 'foo') GROUP BY col1, col2";
    resultRows = new ArrayList<>();
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:1)", 2,1);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 3, 2);
    ...
    explainPlanQuery = "SELECT col1 as groupByCol1, DATETIMECONVERT(col2) transformCol2, sum(col3) as aggregateCol3, count(*), distinctCount(col4) "
        + "FROM testTable "
        + "WHERE col5 in ('a', 'b', 'c') AND col6 not in (1, 2, 3) "
        + "GROUP BY col1, DATETIMECONVERT(col2) "
        + "HAVING sum(col3) > 100 "
        + "ORDER BY col1";
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:groupByCol1, transformCol2, aggregateCol3, count(*), distinctcount(col4))", 0, -1);
    addRowToResultTable(resultRows, "UPDATE_ALIAS(col1->groupByCol1, datetimeconvert(col2)->transformCol2, sum(col3)->aggregateCol3)", 1, 0);
    addRowToResultTable(resultRows, "BROKER_REDUCE(havingFilter:sum(col3) > 100,sort:[col1 DESC],limit:1)", 2, 1);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 3, 2);
    addRowToResultTable(resultRows, "AGGREGATE_GROUPBY(groupKeys:col1,datetimeconvert(col2),aggregations:count(*), sum(col3), distinctcount(col4))", 4, 3);
    addRowToResultTable(resultRows, "APPLY_TRANSFORM(transformFuncs:datetimeconvert(col2))", 5, 4);
    ...
    // Test 24: case
    explainPlanQuery = "SELECT CASE WHEN invertedIndexCol1> 30 THEN 3 WHEN invertedIndexCol1> 20 THEN 2 WHEN invertedIndexCol1> 10 THEN 1 ELSE 0 END "
        + "AS a_category FROM testTable " + LIMIT;
    resultRows = new ArrayList<>();
    addRowToResultTable(resultRows, "SELECT(selectList:a_category)", 0, -1);
    addRowToResultTable(resultRows, "UPDATE_ALIAS(case(greater_than(invertedIndexCol1,30),greater_than(invertedIndexCol1,20),greater_than(invertedIndexCol1,10),3,2,1,0)->a_category)", 1, 0);
    ...
    addRowToResultTable(resultRows, "APPLY_TRANSFORM(transformFuncs:case(greater_than(invertedIndexCol1,30),greater_than(invertedIndexCol1,20),greater_than(invertedIndexCol1,10),3,2,1,0))", 4, 3);
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(sort:[summv(a) ASC],limit:1)", 8, 7);
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(limit:1,postAggregations:times(sum(col1),sum(col2)), plus(sum(col1),sum(col2)), times(5,max(col2)))", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    ...
    addRowToResultTable(resultRows, "BROKER_REDUCE(havingFilter:(min(col4) > 200 AND add(div(sum(add(col1,col2)),100),10) < 300),limit:1,postAggregations:times(min(col4),5), add(div(sum(add(col1,col2)),100),10))", 1, 0);
    addRowToResultTable(resultRows, "SERVER_COMBINE", 2, 1);
    addRowToResultTable(resultRows, "AGGREGATE_GROUPBY(groupKeys:datetimeconvert(col2),aggregations:sum(add(col1,col2)), min(col4))", 3, 2);
  ...
  private void testResultTable(String explainPlanQuery, ResultTable expectedResultTable) {
    ...
    BrokerResponseNative nonTabularBrokerResponse = brokerReduceService.reduceExplainPlanQueryOutputNontabular(queryContext, tableConfig);
